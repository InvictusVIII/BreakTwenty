...
By intentionally submitting a pull request or other contribution for inclusion in BreakTwenty, you agree to the contribution terms in Section 9 of [LICENSE.md](https://github.com/InvictusVIII/BreakTwenty?tab=License-1-ov-file#9-contributions-to-the-official-breaktwenty-project).
...
Use the private reporting process described in [SECURITY.md](https://github.com/InvictusVIII/BreakTwenty?tab=security-ov-file#report-a-security-issue-privately).
